...
<head>
    ...
    if (is_front_page()) {
        ...
        foreach (['about-us', 'services-v1', 'services-v2', 'services-v3', 'cta-v1', 'cta-v2', 'cta-v3', 'portfolio-v1', 'portfolio-v2', 'portfolio-v3', 'testimonials-v1', 'testimonials-v2', 'testimonials-v3'] as $section) {
