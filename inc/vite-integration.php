...
class Vite_Icons_Integration {
    ...
    // ─── Script Tag Modifier ─────────────────────────────────────────────
     ...
     public function set_script_module($tag, $handle, $src) {
         if (!in_array($handle, ['vite-client', 'raven-main', 'header-one-menu', 'header-two-menu', 'header-three-menu', 'slider-js', 'lightbox-js', 'portfolio-filter-js', 'faq-js', 'video-v1-js', 'video-v2-js'])) return $tag;
