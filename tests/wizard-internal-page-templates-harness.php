...
rms_tpl_assert( array( 'about', 'services', 'contact', 'projects', 'testimonials', 'blog' ) === $ready, 'shell-ready types' );
rms_tpl_assert( 'home.php' === $all['blog']['template'], 'blog registry template is home.php' );
rms_tpl_assert( is_readable( dirname( __DIR__ ) . '/home.php' ), 'home.php exists' );
...
rms_tpl_assert( 'home.php' === ( $by_slug['blog']['meta_input']['_wp_page_template'] ?? '' ), 'blog shell assigned home.php' );
rms_tpl_assert( ! isset( $by_slug['home']['meta_input']['_wp_page_template'] ), 'front Home unblueprinted' );
