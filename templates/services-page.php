<!-- Services Page — Internal Services Grid -->
<section class="services-page">
    <div class="container">
        <h2 class="services-page__headline">Our Professional Services</h2>
        <p class="services-page__intro">We deliver quality roofing solutions tailored to protect your home and investment. Explore our full range of services below.</p>
