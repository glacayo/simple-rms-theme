<!-- FAQ V1 — Accordion Clásico -->
<section class="faq-v1" aria-labelledby="faq-v1-heading">
    <div class="container">
        <h2 id="faq-v1-heading" class="faq-v1__headline">Frequently Asked Questions</h2>
        <h3 class="faq-v1__subheadline">Get Answers to Common Roofing Questions</h3>
