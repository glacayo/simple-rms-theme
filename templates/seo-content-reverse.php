...
$classes = 'seo-content seo-content--reverse';
...
?>
<!-- SEO Content Reverse -- Reusable Two-Column Section with Reversed Layout -->
<!--
  This template renders the same content as seo-content.php but with the image
  on the left and text on the right by applying the .seo-content--reverse class.
...
<section class="<?php echo esc_attr($classes); ?>" aria-labelledby="seo-content-heading"<?php if ($bg_style_attr) echo ' style="' . esc_attr($bg_style_attr) . '"'; ?>>
    <div class="container">
        ...
        <div class="seo-content__grid grid-2">
            <!-- Image column (left because reversed) -->
            ...
            <!-- Text column (right because reversed) -->
