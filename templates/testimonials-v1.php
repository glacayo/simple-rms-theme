...
<section class="testimonials-v1" aria-labelledby="testimonials-v1-main-heading">
    <div class="container">
        <h2 id="testimonials-v1-main-heading" class="testimonials-v1__headline">What Our Clients Say</h2>
        <h3 class="testimonials-v1__subheadline">Real Reviews from Real Homeowners</h3>
        ...
        <div class="grid-3 testimonials-v1__grid">
            <article class="testimonials-v1__card">
                ...
                <p class="testimonials-v1__stars" role="img" aria-label="5 out of 5 stars">★★★★★</p>
