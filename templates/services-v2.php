...
<section class="services-v2">
    <div class="container">
        <h2 class="services-v2__headline">What We Offer</h2>
        <h3 class="services-v2__subheadline">Expert Services You Can Rely On</h3>
        ...
        <div class="services-v2__cta">
            <a href="#" class="btn services-v2__cta-btn">Explore Our Services</a>
        </div>
    </div>
</section>
