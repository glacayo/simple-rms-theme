<header class="rms-header-v2" role="banner">
        ...
        <div class="container">
            <div class="rms-header-v2__top-bar-inner">
                ...
                <div class="rms-header-v2__top-bar-right">
                    ...
                    if (!empty($socials)) :
                    ?>
                    <div class="rms-header-v2__social-links">
    ...
    <!-- Main Bar -->
    <div class="rms-header-v2__main-bar">
        <div class="container">
            <div class="rms-header-v2__main-bar-inner">
                ...
                if (!empty($header_logo)) :
                    ...
                    <a href="/" aria-label="Home">
                        <img src="<?php echo esc_url($header_logo); ?>" alt="Simple RMS" width="200" height="60">
                    </a>
                    <?php
                else :
                    ?>
    ...
    <!-- Mobile Menu Overlay -->
    <div class="rms-header-v2__overlay" aria-hidden="true"></div>

    <!-- Mobile Menu Panel -->
    <nav class="rms-header-v2__mobile-menu" id="rms-header-v2-mobile-menu" aria-label="Mobile navigation" aria-hidden="true">
        <div class="rms-header-v2__mobile-menu-header">
            <span class="rms-header-v2__mobile-menu-title">Menu</span>
            <button class="rms-header-v2__menu-close" type="button" aria-label="Close menu">
                &times;
            </button>
        </div>
        <?php
