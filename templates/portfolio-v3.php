...
<section class="portfolio-v3">
    <div class="container">
        <h2 class="portfolio-v3__headline">Project Gallery</h2>
        <h3 class="portfolio-v3__subheadline">Explore Our Work by Category</h3>

        <div class="portfolio-v3__filters">
            <button class="portfolio-v3__filter portfolio-v3__filter--active" type="button">All</button>
            <button class="portfolio-v3__filter" type="button">Residential</button>
            <button class="portfolio-v3__filter" type="button">Commercial</button>
            <button class="portfolio-v3__filter" type="button">Emergency</button>
        </div>

        <div class="portfolio-v3__grid">
            <div class="portfolio-v3__item" data-lightbox="https://placehold.co/800x600">
                ...
                <div class="portfolio-v3__overlay">
                    <span class="portfolio-v3__icon">⊕</span>
