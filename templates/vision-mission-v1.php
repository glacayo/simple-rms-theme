...
<section class="vision-mission-v1" aria-labelledby="vision-mission-v1-heading">
    <div class="container">
        <p class="vision-mission-v1__eyebrow">Who We Are</p>
        <h2 id="vision-mission-v1-heading" class="vision-mission-v1__headline">Our Vision, Mission &amp; Why Homeowners Trust Us</h2>
        <p class="vision-mission-v1__intro">We built this company on a simple promise: protect every home like it's our own. Here's what drives us every day.</p>
