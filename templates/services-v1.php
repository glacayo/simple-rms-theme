...
<section class="services-v1" style="--services-bg: url('https://placehold.co/1920x800');">
    <div class="services-v1__overlay"></div>
    <div class="container">
        <h2 class="services-v1__headline">Our Professional Services</h2>
        <h3 class="services-v1__subheadline">Quality Solutions for Every Need</h3>

        <div class="grid-3">
            <div class="services-v1__card">
                <span class="services-v1__icon">ICON</span>
        ...
        <div class="services-v1__cta">
            <a href="#" class="btn btn--outline-white services-v1__cta-btn">View All Services</a>
        </div>
    </div>
</section>
