...
<section class="portfolio-v2">
    <div class="container">
        <h2 class="portfolio-v2__headline">Featured Work</h2>
        <h3 class="portfolio-v2__subheadline">Browse Our Best Projects</h3>

        <div class="portfolio-v2__grid">
            <div class="portfolio-v2__item">
                ...
                <div class="portfolio-v2__overlay">
                    <span class="portfolio-v2__icon">⊕</span>
